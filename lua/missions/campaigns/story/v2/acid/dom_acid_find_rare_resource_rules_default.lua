return function()
	...
	rules.gameEvents = 
	{
		...
		{ action = "boss_attack",         type = "NEGATIVE", gameStates="ATTACK|STREAMING",         minEventLevel = 8 },
		{ action = "boss_attack",         type = "NEGATIVE", gameStates="ATTACK|NO_STREAMING",      minEventLevel = 8 },
		{ action = "stronger_attack", 	  type = "NEGATIVE", gameStates="ATTACK|STREAMING", 		minEventLevel = 7, amount = 2 },
		{ action = "stronger_attack", 	  type = "NEGATIVE", gameStates="ATTACK|NO_STREAMING", 		minEventLevel = 7, amount = 2 },
		{ action = "stronger_attack", 	  type = "NEGATIVE", gameStates="ATTACK|STREAMING", 		minEventLevel = 8, amount = 3 },
		{ action = "stronger_attack", 	  type = "NEGATIVE", gameStates="ATTACK|NO_STREAMING", 		minEventLevel = 8, amount = 3 },
		{ action = "shegret_attack",      type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING",    minEventLevel = 5, logicFile="logic/event/shegret_attack.logic",  weight = 5 },
		{ action = "shegret_attack",      type = "NEGATIVE", gameStates="ATTACK|IDLE|NO_STREAMING", minEventLevel = 5, logicFile="logic/event/shegret_attack.logic",  weight = 3 },
		...
		{ action = "spawn_earthquake",    type = "NEGATIVE", gameStates="ATTACK|IDLE|NO_STREAMING", minEventLevel = 2, logicFile="logic/weather/earthquake.logic",    minTime = 30, maxTime = 60,  weight = 0.5 },		
		...
		{ action = "spawn_solar_eclipse", type = "NEGATIVE", gameStates="ATTACK|IDLE|NO_STREAMING", minEventLevel = 5, logicFile="logic/weather/solar_eclipse.logic", minTime = 60, maxTime = 120, weight = 0.25 },
		...
		{ action = "spawn_fog",           type = "NEGATIVE", gameStates="ATTACK|IDLE|NO_STREAMING", minEventLevel = 1, logicFile="logic/weather/fog.logic",           minTime = 30, maxTime = 60 },
		...
		{ action = "spawn_wind_weak",     type = "NEGATIVE", gameStates="ATTACK|IDLE|NO_STREAMING", minEventLevel = 1, logicFile="logic/weather/wind_weak.logic",     minTime = 60, maxTime = 120, weight = 0.5 },
		...
		{ action = "spawn_wind_none",     type = "NEGATIVE", gameStates="ATTACK|IDLE|NO_STREAMING", minEventLevel = 1, logicFile="logic/weather/wind_none.logic",     minTime = 30, maxTime = 120, weight = 0.5 },
		...
		{ action = "spawn_acid_rain",     type = "NEGATIVE", gameStates="ATTACK|IDLE|NO_STREAMING", minEventLevel = 3, logicFile="logic/weather/acid_rain.logic",     minTime = 30, maxTime = 30 },
		...
		{ action = "spawn_acid_fissures", type = "NEGATIVE", gameStates="ATTACK|IDLE|NO_STREAMING", minEventLevel = 2, logicFile="logic/weather/acid_fissures.logic", minTime = 30, maxTime = 60,  weight = 2 },
		{ action = "spawn_tornado_acid_near_player", type = "NEGATIVE", gameStates="IDLE",          minEventLevel = 3, logicFile="logic/weather/tornado_acid_near_player.logic", minTime = 30, maxTime = 60, weight = 0.5 },
		...
		{ action = "spawn_meteor_shower", type = "NEGATIVE", gameStates="ATTACK|IDLE|NO_STREAMING", minEventLevel = 4, logicFile="logic/weather/meteor_shower.logic", minTime = 40, maxTime = 90,  weight = 0.5 },	
		{ action = "spawn_comet_silent",  type = "POSITIVE", gameStates="ATTACK|IDLE|NO_STREAMING", minEventLevel = 1, logicFile="logic/weather/comet_silent.logic",  weight = 2 }
