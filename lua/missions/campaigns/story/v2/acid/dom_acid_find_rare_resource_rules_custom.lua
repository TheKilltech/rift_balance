...
return function()
	...
	local difficultyProgressionMultiplier = math.sqrt(buildingSpeedMultiplier)
	...
	for i = 1, #rules.timeToNextDifficultyLevel, 1 do
		rules.timeToNextDifficultyLevel[i] = rules.timeToNextDifficultyLevel[i] * difficultyProgressionMultiplier
	end
