return function(params)
	...
	rules.extraWaves       = helper:Default_ExtraWaves("acid", "hq", rules.params.difficulty, nil)
	rules.multiplayerWaves = helper:Default_MpWaves(   "acid", "hq", rules.params.difficulty, nil)
	rules.bosses           = helper:Default_Bosses(    "acid", "hq", rules.params.difficulty, nil)
	rules.waves = 
	{
		["default"]		= helper:Default_UnboxedWaves("acid",     "hq",   rules.params.difficulty, nil),
