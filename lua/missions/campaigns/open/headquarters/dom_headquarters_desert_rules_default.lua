return function(params)
	...
	rules.extraWaves       = helper:Default_ExtraWaves("desert", "hq", rules.params.difficulty, nil)
	rules.multiplayerWaves = helper:Default_MpWaves(   "desert", "hq", rules.params.difficulty, nil)
	rules.bosses           = helper:Default_Bosses(    "desert", "hq", rules.params.difficulty, nil)
	rules.waves = 
	{
		["default"]		= helper:Default_UnboxedWaves("desert",   "hq",   rules.params.difficulty, nil),
		["acid"]		= helper:Default_UnboxedWaves("acid",     "late", rules.params.difficulty, nil),
		["caverns"]		= helper:Default_UnboxedWaves("caverns",  "late", rules.params.difficulty, nil),
		["desert"]		= helper:Default_UnboxedWaves("desert",   "late", rules.params.difficulty, nil),
		["ice"]			= helper:Default_UnboxedWaves("ice",      "late", rules.params.difficulty, nil),
		["jungle"]		= helper:Default_UnboxedWaves("jungle",   "late", rules.params.difficulty, nil),
		["magma"]		= helper:Default_UnboxedWaves("magma",    "late", rules.params.difficulty, nil),
		["metallic"]	= helper:Default_UnboxedWaves("metallic", "late", rules.params.difficulty, nil),
		["swamp"]		= helper:Default_UnboxedWaves("swamp",    "late", rules.params.difficulty, nil),
	}
