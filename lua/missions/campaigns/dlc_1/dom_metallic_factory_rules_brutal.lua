return function()
    local rules = require("lua/missions/campaigns/dlc_1/dom_metallic_factory_rules_hard.lua")()
	...
	rules.waves = wave_gen:Generate({ groups = { "default" },   difficulty = { 3, 4, 5},             biomes = { "metallic" }, levels = { 1 },   ids = { 2 },      suffixes = { "alpha", "ultra" }, },   rules.waves)
	rules.waves = wave_gen:Generate({ groups = { "default" },   difficulty = { 3, 4, 5, 6},          biomes = { "metallic" }, levels = { 2 },   ids = { 2 },      suffixes = { "" },               },   rules.waves)
	rules.waves = wave_gen:Generate({ groups = { "default" },   difficulty = {    4, 5, 6, 7},       biomes = { "metallic" }, levels = { 2 },   ids = { 2 },      suffixes = { "alpha", "ultra" }, },   rules.waves)
	rules.waves = wave_gen:Generate({ groups = { "default" },   difficulty = {    4, 5, 6, 7},       biomes = { "metallic" }, levels = { 3 },   ids = { 2, 3 },   suffixes = { "" },               },   rules.waves)
	rules.waves = wave_gen:Generate({ groups = { "default" },   difficulty = {       5, 6, 7, 8},    biomes = { "metallic" }, levels = { 3 },   ids = { 2, 3 },   suffixes = { "alpha", "ultra" }, },   rules.waves)
	rules.waves = wave_gen:Generate({ groups = { "default" },   difficulty = {          6, 7, 8,  }, biomes = { "metallic" }, levels = { 4 },   ids = { 2, 3 },   suffixes = { "" },               },   rules.waves)
	rules.waves = wave_gen:Generate({ groups = { "default" },   difficulty = {             7, 8, 9}, biomes = { "metallic" }, levels = { 4 },   ids = { 2, 3 },   suffixes = { "alpha", "ultra" }, },   rules.waves)
